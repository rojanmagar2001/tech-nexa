...
export default function SearchBanner() {
  return (
    <div className="absolute -translate-y-10 w-full h-full flex flex-col justify-center items-center gap-y-10 z-[30] pointer-events-none">
      ...
      <div className="w-fit p-1 sm:p-1.5 bg-slate-300 self-center rounded-xl shadow-xl z-[1] pointer-events-auto">
        <div className="flex flex-col justify-center items-center relative">
          <input
            type="text"
            placeholder="Search for products"
            className="w-[78vw] sm:w-[35vw] 2xl:w-[35vw] p-2 pl-10 text-primary rounded-md focus:outline-none border-0 bg-gray-100"
          />
          <span>
